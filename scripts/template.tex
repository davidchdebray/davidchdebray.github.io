...
% --- linethickness definition ---
\makeatletter
\@ifundefined{linethickness}{
...
\definecolor{lightblue}{HTML}{0395DE}
\definecolor{blue}{HTML}{3333cc}


% Custom section spacing and formatting
\titleformat{\part}{\Huge\scshape\filcenter}{}{1em}{}
\titleformat{\section}{\Large\bf\raggedright}{}{1em}{\color{awesome-red}}[{\titlerule[2pt]}]
\titlespacing{\section}{0pt}{3pt}{7pt}
\titleformat{\subsection}{\large\bfseries\raggedright}{}{0em}{\color{awesome-emerald}\underline}%[\rule{3cm}{.2pt}]
\titlespacing{\subsection}{0pt}{7pt}{7pt}
% \titleformat{\subsubsection{\color{awesome-orange}}
...
$if(colorlinks)$
  colorlinks=true,
  linkcolor=$if(linkcolor)$$linkcolor$$else$Yellow$endif$,
